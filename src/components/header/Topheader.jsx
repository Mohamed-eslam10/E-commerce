...
export default function Topheader() {
    return (
        <div className="font-sans ">
            <div className='flex justify-between px-5 mt-3 gap-5'>
                ...
                <div className='flex gap-4 mt-2'>
                    <div className='relative'>
                        ...
                        <span className='absolute -top-2 -right-2 text-white bg-sky-600 h-4 w-4 rounded-full flex items-center justify-center text-xs'>0</span>
                    </div>
                    <div className='relative'>
